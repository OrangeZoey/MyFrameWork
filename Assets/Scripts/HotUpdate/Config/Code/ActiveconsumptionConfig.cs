    ...
    public partial struct ActiveconsumptionConfig
    {
        public static void DeserializeByAddressable(string directory)
        {
            ...
            for (int i = 0; i < array.Count; i++)
            {
                ...
                ActiveconsumptionConfig data = (ActiveconsumptionConfig)dataObject.ToObject(typeof(ActiveconsumptionConfig));
                datas.Add(data);
        ...
        {
            string bundleName = $"{subFolder}/ActiveconsumptionConfig.bytes".ToLower();
        ...
        private static List<ActiveconsumptionConfig> datas;
        private static Dictionary<int, int> indexMap;
        public static ActiveconsumptionConfig ByID(int id)
        {
            if (id <= 0)
            {
                return Null;
            ...
            {
                throw new System.Exception($"ActiveconsumptionConfig找不到ID:{id}");
            }
            return ByIndex(index);
        }
        public static ActiveconsumptionConfig ByIndex(int index)
        {
            return datas[index];
        }
        public bool IsNull { get; private set; }
        public static ActiveconsumptionConfig Null { get; } = new ActiveconsumptionConfig() { IsNull = true }; 
        ...
        public System.Int32 get_way { get; set; }
