...
public class MessageType
{
    ...
    public struct BagViewMess
    {

    }
    public struct ShowPowerPropTipUIView
    {

    }
    public struct OtherEquipTipUIView
    {

    }

    public struct CreateLogin
    {
        public string name;
    }
